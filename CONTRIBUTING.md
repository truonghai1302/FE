# Contributing to entry-test

We would love for you to contribute to entry-test and help make it ever better together! :rocket:
...
Help us keep entry-test open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `entry-test`.
...
* If you have a question about using entry-test, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `entry-test:master`.
...
we use the git commit messages to **generate the entry-test change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/entry-test
[stackoverflow]: https://stackoverflow.com/questions/tagged/entry-test
[issues]: https://github.com/akveo/entry-test/issues
[new_issue]: https://github.com/akveo/entry-test/issues/new
[pulls]: https://github.com/akveo/entry-test/pulls
